 ...
 *
 * This file is based on the "CMSIS\Core_A\Include\cmsis_gcc.h"
 *
 * Changes:
...
#define __get_CP(cp, op1, Rt, CRn, CRm,                                                                              \
                 op2)      __ASM volatile ("MRS %0, S" # cp "_" # op1 "_C" # CRn "_C" # CRm "_" # op2: "=r" (Rt) : : \
                                           "memory")
#define __set_CP(cp, op1, Rt, CRn, CRm,                                                                                 \
                 op2)      __ASM volatile ("MSR S" # cp "_" # op1 "_C" # CRn "_C" # CRm "_" # op2 ", %0" : : "r" (Rt) : \
                                           "memory")

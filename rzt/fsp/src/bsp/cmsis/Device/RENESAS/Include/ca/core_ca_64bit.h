 ...
 *
 * This file is based on the "CMSIS\Core_A\Include\core_ca.h"
 *
 * Changes:
...
/*  CMSIS CA definitions */
 ...
 #include "cmsis_compiler_64bit.h"     /* CMSIS compiler specific defines */
 ...
 * \return          0
 */
__STATIC_INLINE int MMU_GetPageDescriptor (uint32_t * descriptor, uint32_t * descriptor2,
                                   ...
                                   uint32_t   descriptor_l2)
{
    ...
    offset = base_address >> 20;
    entry  = ((int64_t) ttb_l2 & 0xFFFFFC00) | descriptor_l1;

 ...
 * */
typedef enum e_elc_event_rzt2m
{
    ...
    ELC_EVENT_ENCIF_INT0     = (372),  // ENCIF CH0 Interrupt A
    ELC_EVENT_ENCIF_INT1     = (373),  // ENCIF CH0 Interrupt B
    ELC_EVENT_ENCIF_INT2     = (374),  // ENCIF CH0 OUTPUT FIFO Interrupt
    ELC_EVENT_ENCIF_INT3     = (375),  // ENCIF CH0 INPUT FIFO Interrupt
    ELC_EVENT_ENCIF_INT4     = (376),  // ENCIF CH1 Interrupt A
    ELC_EVENT_ENCIF_INT5     = (377),  // ENCIF CH1 Interrupt B
    ELC_EVENT_ENCIF_INT6     = (378),  // ENCIF CH1 OUTPUT FIFO Interrupt
    ...
    ELC_EVENT_CPU1_ERR0      = (386),  // Cortex-R52 CPU1 error event 0
    ELC_EVENT_CPU1_ERR1      = (387),  // Cortex-R52 CPU1 error event 1

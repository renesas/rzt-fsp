...
#define BSP_FEATURE_ADC_MTU3_TRIGGER_SUPPORTED_UNIT_MASK       (0x1U) // Trigger source from MTU3 is not available in ADC12 unit 1.
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                        (0x00FFU) // 0 to 7 in unit 0
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                        (0xFFFFU) // 0 to 15 in unit 1
...
#define BSP_FEATURE_BSP_BOOT_PARAMETER                         (2U)
...
#define BSP_FEATURE_BSP_MASTER_MPU8_SUPPORTED                  (0U)
...
#define BSP_FEATURE_BSP_ENCIF_MSTP_SUPPORTED                   (1U)
...
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR6_REG_MASK              (0x00000000U)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR7_REG_MASK              (0x00000000U)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR8_REG_MASK              (0x00000000U)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR9_REG_MASK              (0x00000000U)
...
#define BSP_FEATURE_RSIP_OTF_CHANNEL                           (2U)
...
#define BSP_FEATURE_XSPI_HAS_XSPI_MISC2                        (1U)

...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                        (0x00FFU) // 0 to 7 in unit0
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                        (0xFFFFU) // 0 to 15 in unit1
...
#define BSP_FEATURE_XSPI_OTFD_SUPPORTED                        (1U)

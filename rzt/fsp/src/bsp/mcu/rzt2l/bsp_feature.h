...
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                   (0x000F) // 0 to 3 in unit 1
...
#define BSP_FEATURE_ETHSS_SWITCH_MODE_BIT_MASK            (1U)
...
#define BSP_FEATURE_ICU_ERROR_PERI_ERR1_REG_MASK          (0xF9FEA07FU)
#define BSP_FEATURE_ICU_ERROR_PERI_ERR2_REG_MASK          (0xFFFFFFFFU)
...
#define BSP_FEATURE_ICU_INTER_CPU_IRQ_NS_SWINT_MASK       (0x00000000U)
#define BSP_FEATURE_ICU_INTER_CPU_IRQ_S_SWINT_MASK        (0x00000000U)
...
#define BSP_FEATURE_POEG_ERROR_SIGNAL_TYPE                (2U)

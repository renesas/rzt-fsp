 ...
 * */
typedef enum e_elc_event_rzt2l
{
    ...
    ELC_EVENT_DMAC0_INT8      = (29),  // DMAC0 transfer completion 8
    ELC_EVENT_DMAC0_INT9      = (30),  // DMAC0 transfer completion 9
    ELC_EVENT_DMAC0_INT10     = (31),  // DMAC0 transfer completion 10
    ELC_EVENT_DMAC0_INT11     = (32),  // DMAC0 transfer completion 11
    ELC_EVENT_DMAC0_INT12     = (33),  // DMAC0 transfer completion 12
    ELC_EVENT_DMAC0_INT13     = (34),  // DMAC0 transfer completion 13
    ELC_EVENT_DMAC0_INT14     = (35),  // DMAC0 transfer completion 14
    ELC_EVENT_DMAC0_INT15     = (36),  // DMAC0 transfer completion 15
    ...
    ELC_EVENT_DMAC1_INT8      = (45),  // DMAC1 transfer completion 8
    ELC_EVENT_DMAC1_INT9      = (46),  // DMAC1 transfer completion 9
    ELC_EVENT_DMAC1_INT10     = (47),  // DMAC1 transfer completion 10
    ELC_EVENT_DMAC1_INT11     = (48),  // DMAC1 transfer completion 11
    ELC_EVENT_DMAC1_INT12     = (49),  // DMAC1 transfer completion 12
    ELC_EVENT_DMAC1_INT13     = (50),  // DMAC1 transfer completion 13
    ELC_EVENT_DMAC1_INT14     = (51),  // DMAC1 transfer completion 14
    ELC_EVENT_DMAC1_INT15     = (52),  // DMAC1 transfer completion 15
    ...
    ELC_EVENT_ENDAT0_INT1     = (255), // ENDAT0 interrupt output 1
    ELC_EVENT_ENDAT1_INT1     = (258), // ENDAT1 interrupt output 1
    ELC_EVENT_BISS0_EOT       = (261), // BISS0 End of transmission interrupt
    ELC_EVENT_BISS1_EOT       = (262), // BISS1 End of transmission interrupt
    ELC_EVENT_HDSL0_INT       = (263), // HDSL0 Interrupt output
    ELC_EVENT_HDSL0_INTS      = (264), // HDSL0 Interrupt output (safety related)
    ELC_EVENT_HDSL1_INT       = (265), // HDSL1 Interrupt output
    ELC_EVENT_HDSL1_INTS      = (266), // HDSL1 Interrupt output (safety related)
    ELC_EVENT_AFMT0_EOF       = (267), // AFMT0 communication completion
    ELC_EVENT_AFMT1_EOF       = (268), // AFMT1 communication completion
    ELC_EVENT_GMAC_PTPOUT0    = (269), // GMAC PTP timer pulse output 0
    ELC_EVENT_GMAC_PTPOUT1    = (270), // GMAC PTP timer pulse output 1
    ELC_EVENT_GMAC_PTPOUT2    = (271), // GMAC PTP timer pulse output 2
    ELC_EVENT_GMAC_PTPOUT3    = (272), // GMAC PTP timer pulse output 3
    ELC_EVENT_HDSL0_FPR       = (273), // HDSL0 Fast position value ready interrupt
    ELC_EVENT_HDSL1_FPR       = (274), // HDSL1 Fast position value ready interrupt
    ELC_EVENT_HDSL0_SP        = (275), // HDSL0 Safe position received interrupt
    ELC_EVENT_HDSL1_SP        = (276), // HDSL1 Safe position received interrupt
    ...
    ELC_EVENT_DSMIF0_CDUPDC   = (376), // DSMIF0 current data register update common
    ELC_EVENT_DSMIF0_CDACUPDC = (377), // DSMIF0 current capture data register A update common
    ELC_EVENT_DSMIF0_CDBCUPDC = (378), // DSMIF0 current capture data register B update common
    ELC_EVENT_DSMIF1_CDUPDC   = (379), // DSMIF1 current data register update common
    ELC_EVENT_DSMIF1_CDACUPDC = (380), // DSMIF1 current capture data register A update common
    ELC_EVENT_DSMIF1_CDBCUPDC = (381), // DSMIF1 current capture data register B update common

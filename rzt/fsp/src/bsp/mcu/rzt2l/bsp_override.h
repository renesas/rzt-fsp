...
typedef enum e_error_event
{
    ...
    ERROR_EVENT_PERIPHERAL_3,          ///< Error event from Peripheral 3
} error_event_t;
...
typedef enum e_poe3_state
{
    ...
    POE3_STATE_DSMIF0_0_ERROR_REQUEST = 1U << 7,                ///< Timer output disabled due to DSMIF0 Error0
    POE3_STATE_DSMIF1_0_ERROR_REQUEST = 1U << 8,                ///< Timer output disabled due to DSMIF1 Error0
    ...
    POE3_STATE_DSMIF0_1_ERROR_REQUEST = 1U << 11,               ///< Timer output disabled due to DSMIF0 Error1
    POE3_STATE_DSMIF1_1_ERROR_REQUEST = 1U << 12,               ///< Timer output disabled due to DSMIF1 Error1
} poe3_state_t;

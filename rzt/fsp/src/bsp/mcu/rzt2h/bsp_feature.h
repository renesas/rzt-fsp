...
#define BSP_FEATURE_ADC_UNIT_2_CHANNELS                        (0x003FU) // 0 to 15 in unit 2
...
#define BSP_FEATURE_BSC_NOR_CS0_BASE_MIRROR_ADDRESS            (0U)
#define BSP_FEATURE_BSC_NOR_CS2_BASE_MIRROR_ADDRESS            (0U)
#define BSP_FEATURE_BSC_NOR_CS3_BASE_MIRROR_ADDRESS            (0U)
#define BSP_FEATURE_BSC_NOR_CS5_BASE_MIRROR_ADDRESS            (0U)

#define BSP_FEATURE_BSP_AFMT_UNIT                              (16U)
#define BSP_FEATURE_BSP_BISS_UNIT                              (16U)
...
#define BSP_FEATURE_BSP_HDSL_UNIT                              (16U)
...
#define BSP_FEATURE_DSMIF_UNIT                                 (10U)
#define BSP_FEATURE_DSMIF_VALID_UNIT_MASK                      (0x3FFU)
...
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR6_REG_MASK              (0x1FFFFFFFU)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR7_REG_MASK              (0x1FFFFFFFU)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR8_REG_MASK              (0x1FFFFFFFU)
#define BSP_FEATURE_ICU_ERROR_DSMIF_ERR9_REG_MASK              (0x1FFFFFFFU)

...
/* SPI clock options. */
#define BSP_CLOCKS_SPI0_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SPI0 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SPI0_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SPI0 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SPI1_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SPI1 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SPI1_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SPI1 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SPI2_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SPI2 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SPI2_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SPI2 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SPI3_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SPI3 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SPI3_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SPI3 asynchronous serial clock 96.0 MHz.

/* SCI clock options. */
#define BSP_CLOCKS_SCI0_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI0 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI0_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI0 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SCI1_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI1 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI1_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI1 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SCI2_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI2 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI2_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI2 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SCI3_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI3 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI3_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI3 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SCI4_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI4 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI4_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI4 asynchronous serial clock 96.0 MHz.
#define BSP_CLOCKS_SCI5_ASYNCHRONOUS_SERIAL_CLOK_75_MHZ    (0)    // SCI5 asynchronous serial clock 75.0 MHz.
#define BSP_CLOCKS_SCI5_ASYNCHRONOUS_SERIAL_CLOK_96_MHZ    (1)    // SCI5 asynchronous serial clock 96.0 MHz.
...
#define BSP_PRV_FSELCPU1_INIT                              (0x20U)

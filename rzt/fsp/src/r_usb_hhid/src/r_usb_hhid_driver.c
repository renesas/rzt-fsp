...
/* variables */
static uint16_t  g_usb_hhid_request_setup[USB_NUM_USBIP][5] USB_BUFFER_PLACE_IN_SECTION; /* Control Transfer Request field */
static usb_utr_t usb_shhid_string_req[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;        /* Request for String discriptor */
...
uint16_t  g_usb_hhid_protocol[USB_NUM_USBIP][USB_MAXDEVADDR * USB_OHCI_DEVICE_ENDPOINT_MAX + 1];        /* HID Device protocol(Mouse/Keyboard) */
uint16_t  g_usb_hhid_num_endpoint[USB_NUM_USBIP][USB_MAXDEVADDR * USB_OHCI_DEVICE_ENDPOINT_MAX + 1];    /* Num Endpoints */
uint16_t  g_usb_hhid_outpipe_support[USB_NUM_USBIP][USB_MAXDEVADDR * USB_OHCI_DEVICE_ENDPOINT_MAX + 1]; /* OUT pipe support */
uint8_t   g_usb_hhid_string_data[USB_NUM_USBIP][USB_HHID_CLSDATASIZE] USB_BUFFER_PLACE_IN_SECTION;
...
uint8_t * g_p_usb_hhid_config_table[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;                         /* Configuration Descriptor Table */
uint8_t * g_p_usb_hhid_device_table[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;                         /* Device Descriptor Table */

...
/* See only CD pin because DAT3 pin is not used for card detection. */
...
/* DM_CM_DTRAN_MODE */
#define SDHI_PRV_SDHI_DM_CM_DTRAN_MODE_BUS_WIDTH           (3U << 4)  // Bus width Selector(11:64-bit ony)
#define SDHI_PRV_SDHI_DM_CM_DTRAN_MODE_CHNUM0              (0U << 16) // DMAC channel 0 selector
#define SDHI_PRV_SDHI_DM_CM_DTRAN_MODE_CHNUM1              (1U << 16) // DMAC channel 1 selector

/* DM_CM_DTRAN_CTRL */
#define SDHI_PRV_SDHI_DM_CM_DTRAN_CTRL_DM_START            (1U << 0)  // DMAC Start

/* DM_CM_INFO1 */
#define SDHI_PRV_SDHI_DM_CM_INFO1_SEQEND                   (1U << 0)  // Sequencer Operation End
#define SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND0                (1U << 16) // Module built-in DMAC Channel 0 Transfer End
#define SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND1                (1U << 20) // Module built-in DMAC Channel 1 Transfer End

#define SDHI_PRV_SDHI_DM_CM_INFO1_MASK                     ((SDHI_PRV_SDHI_DM_CM_INFO1_SEQEND |    \
                                                             SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND0 | \
                                                             SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND1))

/* DM_CM_INFO2 */
#define SDHI_PRV_SDHI_DM_CM_INFO2_SEQERR                   (1U << 0)  // Sequencer Error
#define SDHI_PRV_SDHI_DM_CM_INFO2_DTRANERR0                (1U << 16) // Module built-in DMAC Channel 0 Error
#define SDHI_PRV_SDHI_DM_CM_INFO2_DTRANERR1                (1U << 17) // Module built-in DMAC Channel 1 Error

#define SDHI_PRV_SDHI_DM_CM_INFO2_MASK                     ((SDHI_PRV_SDHI_DM_CM_INFO2_SEQERR |    \
...
#define SDHI_PRV_SD_CC_EXT_MODE_DMASDRW_SET                (0x1012U) // 1 must always be written to bit 4 and 12 of CC_EXT_MODE.
#define SDHI_PRV_SD_CC_EXT_MODE_DMASDRW_CLEAR              (0x1010U) // Added setting for SDHI built-in DMAC.
...
#define SDHI_PRV_SD_STATUS_SD_PWEN_BIT                     (0U)
#define SDHI_PRV_SD_STATUS_SD_IOVS_BIT                     (16U)
#define SDHI_PRV_SD_STATUS_SD_PWEN_MASK                    (1 << 0)
#define SDHI_PRV_SD_STATUS_SD_IOVS_MASK                    (1 << 16)
#define SDHI_PRV_SD_STATUS_MASK_PIN_CFG                    (SDHI_PRV_SD_STATUS_SD_PWEN_MASK | \
                                                            SDHI_PRV_SD_STATUS_SD_IOVS_MASK)

#define SDHI_PRV_HOST_MODE_WMODE_BIT                       (0U)
#define SDHI_PRV_HOST_MODE_BUSWIDTH_BIT                    (8U)

/* Card access interrupt flag at SD_INFO1. */
#define SDHI_PRV_CARD_ACCS_INT_REQ_MASK_SD_INFO1           ((SDHI_PRV_SDHI_INFO1_RESPONSE_END | \
                                                             SDHI_PRV_SDHI_INFO1_ACCESS_END))

/* Card access interrupt flag at SD_INFO2. */
#define SDHI_PRV_CARD_ACCS_INT_REQ_MASK_SD_INFO2           ((SDHI_PRV_SDHI_INFO2_CARD_ILA_ERR | \
                                                             SDHI_PRV_SDHI_INFO2_CARD_BWE |     \
                                                             SDHI_PRV_SDHI_INFO2_CARD_BRE |     \
                                                             SDHI_PRV_SDHI_INFO2_CARD_RSPT |    \
                                                             SDHI_PRV_SDHI_INFO2_CARD_ILR |     \
                                                             SDHI_PRV_SDHI_INFO2_CARD_ILW |     \
                                                             SDHI_PRV_SDHI_INFO2_CARD_DTO |     \
                                                             SDHI_PRV_SDHI_INFO2_CARD_END_ERR | \
                                                             SDHI_PRV_SDHI_INFO2_CARD_CRC_ERR | \
                                                             SDHI_PRV_SDHI_INFO2_CARD_CMD_ERR))

/* Card detect interrupt flag at SD_INFO1. */
#define SDHI_PRV_CARD_DETECT_INT_REQ_MASK_INFO1            ((SDHI_PRV_SDHI_INFO1_CARD_DAT3_INSERTED | \
                                                             SDHI_PRV_SDHI_INFO1_CARD_DAT3_REMOVED |  \
                                                             SDHI_PRV_SDHI_INFO1_CARD_INSERTED |      \
                                                             SDHI_PRV_SDHI_INFO1_CARD_REMOVED))

/* DMAC interrupt flag at SD_INFO1. */
#define SDHI_PRV_DMAC_INT_REQ_MASK_INFO3                   ((SDHI_PRV_SDHI_DM_CM_INFO1_SEQEND |    \
                                                             SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND0 | \
                                                             SDHI_PRV_SDHI_DM_CM_INFO1_DTRANEND1))

/* RST Low period(at least 1us) with margin(1us) for eMMC H/W reset operation. */
#define SDHI_PRV_EMMC_RESET_LOW_PERIOD_US                  (2)

/* RST High period(at least 100us) with margin (100us) for eMMC H/W reset operation. */
#define SDHI_PRV_EMMC_RESET_HIGH_PERIOD_US                 (200)
...
static void sdhimmc_accs_isr(void);

static void sdhimmc_card_isr(void);

static void sdhimmc_dmac_isr(void);

void sdhimmc_oxmnirq_isr(void);

/***********************************************************************************************************************
 * Private global variables
 **********************************************************************************************************************/
static uint32_t uncached_buf[BSP_FEATURE_SDHI_MAX_CHANNELS][SDHI_MAX_BLOCK_SIZE /
                                                            sizeof(uint32_t)] BSP_ALIGN_VARIABLE(8) BSP_PLACE_IN_SECTION(
    ".noncache_buffer");
...
fsp_err_t R_SDHI_Open (sdmmc_ctrl_t * const p_api_ctrl, sdmmc_cfg_t const * const p_cfg)
{
    ...
    p_ctrl->p_aligned_buff = &uncached_buf[p_cfg->channel][0];

    /* Release Slave Stop Function. */
    R_BSP_RegisterProtectDisable(BSP_REG_PROTECT_SYSTEM);
    if (0 == p_cfg->channel)
    {
        R_BSP_SlaveStopRelease(BSP_BUS_SLAVE_SDHI0);
    }
    else if (1 == p_cfg->channel)
    {
        R_BSP_SlaveStopRelease(BSP_BUS_SLAVE_SDHI1);
    }
    else
    {
        /* Do nothing. */
    ...
    R_BSP_MODULE_START(FSP_IP_SDHI, p_cfg->channel);
    ...
    const sdhi_extended_cfg_t * p_extend = (const sdhi_extended_cfg_t *) p_ctrl->p_cfg->p_extend;
    r_sdhi_irq_enable(p_extend->oxmnirq_irq, p_extend->oxmnirq_ipl, p_ctrl);
 ...
 * @retval     FSP_ERR_NOT_ENABLED           When unaligned access is disabled, the alignment of p_dest is incorrect.
 **********************************************************************************************************************/
                       ...
                       uint32_t const       sector_count)
{
    ...
    /* If unaligned access configuration is disabled, p_dest must be 8-byte aligned. */
    FSP_ERROR_RETURN(((uintptr_t) p_dest & 0x7U) == 0x00, FSP_ERR_NOT_ENABLED);
 #endif
#endif
 ...
 * @retval     FSP_ERR_NOT_ENABLED           When unaligned access is disabled, the alignment of p_src is incorrect.
 **********************************************************************************************************************/
                        ...
                        uint32_t const        sector_count)
{
    ...
    /* If unaligned access configuration is disabled, p_source must be 8-byte aligned. */
    FSP_ERROR_RETURN(((uintptr_t) p_source & 0x7U) == 0x00, FSP_ERR_NOT_ENABLED);
 #endif
#endif
    err = r_sdhi_common_error_check(p_ctrl);
    FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
...
fsp_err_t R_SDHI_StatusGet (sdmmc_ctrl_t * const p_api_ctrl, sdmmc_status_t * const p_status)
{
    ...
    if (SDMMC_CARD_DETECT_CD == p_ctrl->p_cfg->card_detect)
    {
        p_status->card_inserted = p_ctrl->p_reg->SD_INFO1_b.INFO5;
    }
    else
    {
...
fsp_err_t R_SDHI_Close (sdmmc_ctrl_t * const p_api_ctrl)
{
    ...
    const sdhi_extended_cfg_t * p_extend = (const sdhi_extended_cfg_t *) p_ctrl->p_cfg->p_extend;
    r_sdhi_irq_disable(p_extend->oxmnirq_irq);
...
static fsp_err_t r_sdhi_open_param_check (sdhi_instance_ctrl_t * p_ctrl, sdmmc_cfg_t const * const p_cfg)
{
    ...
    const sdhi_extended_cfg_t * p_extend = (const sdhi_extended_cfg_t *) p_cfg->p_extend;
    FSP_ERROR_RETURN(p_extend->oxmnirq_irq >= 0, FSP_ERR_IRQ_BSP_DISABLED);
...
static void r_sdhi_access_irq_process (sdhi_instance_ctrl_t * p_ctrl, sdmmc_callback_args_t * p_args)
{
    ...
    volatile uint32_t dummy = p_ctrl->p_reg->SD_INFO1;
    FSP_PARAMETER_NOT_USED(dummy);
    dummy = p_ctrl->p_reg->SD_INFO2;
    FSP_PARAMETER_NOT_USED(dummy);
    ...
    if (flags.bit.response_end)
    {
        ...
        if (1U == p_ctrl->p_reg->SD_STOP_b.SEC)
        {
            ...
            p_args->response.status = p_ctrl->p_reg->SD_RSP54L;
        }
        else
        {
            p_args->response.status = p_ctrl->p_reg->SD_RSP10L;
        }
        ...
        else
        {
            ...
            if (p_ctrl->transfer_dir == SDHI_TRANSFER_DIR_WRITE)
            {
                /* For unaligned access write process, the CPU writes data to the SD_BUF0 register using the BWE flag interrupt.
                 * Therefore, enable interrupts using the BWE flag.
                 * The BWE interrupt is enabled after the END response is received.
                 * Reference section 'Multiple Block Write (when Using Internal Timer)' of the RZ microprocessor manual.*/
                p_ctrl->p_reg->SD_INFO2_MASK &= ~(SDHI_PRV_SDHI_INFO2_CARD_BWE);
            }
        }
    }
    ...
    {
        /* Check for SD_BUF Read/Write Enable for unaligned access */
        if (((flags.bit.bre) && (SDHI_TRANSFER_DIR_READ == p_ctrl->transfer_dir)) ||
            ((flags.bit.bwe) && (SDHI_TRANSFER_DIR_WRITE == p_ctrl->transfer_dir)))
        {
            r_sdhi_transfer_callback(p_ctrl, p_args);
        }
         ...
         divisor_shift++)
    {
        if ((frequency >> divisor_shift) <= max_rate)
        {
            ...
            while (timeout > 0U)
            {
                ...
                if (p_ctrl->p_reg->SD_INFO2_b.SCLKDIVEN)
                {
...
/*******************************************************************************************************************//**
 * Initializes SD SD_RST pin, SD_PWEN pin and SD_IOVS pin.
 *
 * @param[in]  p_ctrl                    Pointer to the instance control block.
 *
...
#if SDHI_CFG_SD_SUPPORT_ENABLE
    sdhi_extended_cfg_t * p_extend = (sdhi_extended_cfg_t *) p_ctrl->p_cfg->p_extend;

    uint32_t sd_status = p_ctrl->p_reg->SD_STATUS;
    sd_status &= (uint32_t) (~SDHI_PRV_SD_STATUS_MASK_PIN_CFG);
    sd_status |= (uint32_t) (p_extend->sd_pwen_output << SDHI_PRV_SD_STATUS_SD_PWEN_BIT |
                             p_extend->sd_iovs_output << SDHI_PRV_SD_STATUS_SD_IOVS_BIT);
    p_ctrl->p_reg->SD_STATUS = sd_status;
...
static fsp_err_t r_sdhi_hw_cfg (sdhi_instance_ctrl_t * const p_ctrl)
{
    ...
    p_ctrl->p_reg->CC_EXT_MODE = SDHI_PRV_SD_CC_EXT_MODE_DMASDRW_CLEAR; // Not in DMA mode initially.
...
static fsp_err_t r_sdhi_sd_card_check (sdhi_instance_ctrl_t * const p_ctrl)
{
    ...
    response.status = p_ctrl->p_reg->SD_RSP10L;
...
static void r_sdhi_write_protect_get (sdhi_instance_ctrl_t * const p_ctrl)
{
    ...
    {
        p_ctrl->device.write_protected = (p_ctrl->p_reg->SD_INFO1_b.INFO7 == 0U);
    }
}
...
static fsp_err_t r_sdhi_sd_high_speed (sdhi_instance_ctrl_t * const p_ctrl)
{
    ...
    uint8_t * p_read_data_8 = (uint8_t *) &p_ctrl->p_aligned_buff[0];
                                  ...
                                  sdmmc_priv_csd_reg_t * const p_csd_reg)
{
    ...
    p_csd_reg->reg.sdrsp10 = p_ctrl->p_reg->SD_RSP10L;
    p_csd_reg->reg.sdrsp32 = p_ctrl->p_reg->SD_RSP32;
    p_csd_reg->reg.sdrsp54 = p_ctrl->p_reg->SD_RSP54L;
...
static fsp_err_t r_sdhi_csd_extended_get (sdhi_instance_ctrl_t * const p_ctrl, uint32_t rca, uint8_t * p_device_type)
{
    ...
    *p_device_type = p_read_data_8[SDHI_PRV_EMMC_EXT_CSD_DEVICE_TYPE_OFFSET];
    ...
    {
        p_ctrl->device.sector_count = p_ctrl->p_aligned_buff[SDHI_PRV_EMMC_EXT_CSD_SEC_COUNT_OFFSET / sizeof(uint32_t)];
    }
                                        ...
                                        uint32_t                     byte_count)
{
    ...
    fsp_err_t err = r_sdhi_transfer_read(p_ctrl, 1U, byte_count, p_ctrl->p_aligned_buff);
    FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
...
{
#if !SDMMC_CFG_UNALIGNED_ACCESS_ENABLE
    FSP_PARAMETER_NOT_USED(block_count);
...
static void r_sdhi_transfer_end (sdhi_instance_ctrl_t * const p_ctrl)
{
    ...
    p_ctrl->p_reg->DM_CM_DTRAN_CTRL = 0U;
    p_ctrl->p_reg->CC_EXT_MODE      = SDHI_PRV_SD_CC_EXT_MODE_DMASDRW_CLEAR;
}
...
/*******************************************************************************************************************//**
 * Clears SDHI DMAC interrupt flag
 **********************************************************************************************************************/
static void sdhimmc_dmac_isr ()
{
    IRQn_Type irq = R_FSP_CurrentIrqGet();

    sdhi_instance_ctrl_t * p_ctrl = (sdhi_instance_ctrl_t *) R_FSP_IsrContextGet(irq);

    uint32_t dm_cm_info1;
    dm_cm_info1                 = p_ctrl->p_reg->DM_CM_INFO1;
    dm_cm_info1                &= SDHI_PRV_SDHI_DM_CM_INFO1_MASK;
    p_ctrl->p_reg->DM_CM_INFO1 &= (~dm_cm_info1);

    /* Dummy read to ensure that interrupt event is cleared. */
    volatile uint32_t dummy = p_ctrl->p_reg->DM_CM_INFO1;
    FSP_PARAMETER_NOT_USED(dummy);
}

/*******************************************************************************************************************//**
 * SDHI Card access interrupt, Card detect interrupt and DMAC interrupt ISR
 **********************************************************************************************************************/
void sdhimmc_oxmnirq_isr (void)
{
    SDHI_CFG_MULTIPLEX_INTERRUPT_ENABLE;
    ...
    uint32_t info1       = p_ctrl->p_reg->SD_INFO1;
    uint32_t info2       = p_ctrl->p_reg->SD_INFO2;
    uint32_t dm_cm_info1 = p_ctrl->p_reg->DM_CM_INFO1;

    if ((0 != (info1 & SDHI_PRV_CARD_ACCS_INT_REQ_MASK_SD_INFO1)) ||
        (0 != (info2 & SDHI_PRV_CARD_ACCS_INT_REQ_MASK_SD_INFO2)))
    {
        /* Card access interrupt */
        sdhimmc_accs_isr();
    }
    else if (0 != (info1 & SDHI_PRV_CARD_DETECT_INT_REQ_MASK_INFO1))
    {
        /* Card detect interrupt */
        sdhimmc_card_isr();
    }
    else if (0U != (dm_cm_info1 & SDHI_PRV_DMAC_INT_REQ_MASK_INFO3))
    {
        /* DMAC interrupt */
        sdhimmc_dmac_isr();
    }
    ...
    SDHI_CFG_MULTIPLEX_INTERRUPT_DISABLE;
}

...
/* PRQA S 1055 ++ # D006 Develop according to C99 */
/* PRQA S 3384 ++ # D012 No problem if wraparound occurs */
...
/**********************************************************************************************************************
 * Function Name : r_sb_cmn_fc_is_sb_flow_correct
 **********************************************************************************************************************/

/*!****************************************************************************************************************//**
 * \ingroup     SBLIBCommonAPIsInternal
 * \brief       Check if the SecureBoot flow is correct \n
 *              This function is an inline function
 * \return
 *  - SB_PRV_TRUE:        (#SB_PRV_CMN_FC_SECUREBOOT_INIT + #SB_PRV_CMN_FC_SECUREBOOT_TOTAL_CNT) == #g_sb_flow_counter
 *  - SB_PRV_FALSE:       (#SB_PRV_CMN_FC_SECUREBOOT_INIT + #SB_PRV_CMN_FC_SECUREBOOT_TOTAL_CNT) != #g_sb_flow_counter
 * \par Global Variables
 *  - #g_sb_flow_counter
 *
 * \callgraph

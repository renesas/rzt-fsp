...
/* PRQA S 3630 ++ # D020 Header file used only by the library */
...
/** Code Certificate + Encryteped Image Signature */
...
#define SB_PRV_TLV_TYPE_CLS_CRC_POLY_CRC32    (0x0UL << (SB_PRV_TLV_TYPE_CLS_CRC_POLY_POS)) /**< Polynomial CRC32 */
...
extern sb_ret_t r_sb_mani_set_code_cert_st(const uint8_t * const p_code_cert, st_sb_code_cert_t * const p_code_cert_st);
...
extern sb_ret_t r_sb_mani_parse_tlvs(const uint8_t * const                 p_top,

...
void r_rsip_func016 (uint32_t ARG1)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x69b9abccU),
                   bswap_32big(0xdaaaccc4U),
                   bswap_32big(0x30147f99U),
                   bswap_32big(0x4a7d2154U));
    ...
    for (oLoop = 0; oLoop < S_RAM[0 + 2]; oLoop = oLoop + 4)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func100(bswap_32big(0x57af7b90U), bswap_32big(0xf320d7c6U), bswap_32big(0xb2342925U),
                       bswap_32big(0xa133f36dU));
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0x344290fdU), bswap_32big(0x9645a201U), bswap_32big(0xf539179eU),
                       bswap_32big(0x63a89c8fU));
    }
    ...
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0x1579d4f5U),
                   bswap_32big(0x0ddf2eedU),
                   bswap_32big(0x3afbbedbU),
                   bswap_32big(0x79e13153U));
    WR1_PROG(REG_1444H, 0x000000a2U);

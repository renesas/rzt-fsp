...
void r_rsip_func440 (const uint32_t ARG1[])
{
    ...
    WR1_PROG(REG_1458H, 0x00000000U);
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x00000440U));
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func101(bswap_32big(0xc996b25cU),
                   bswap_32big(0x8c19374dU),
                   bswap_32big(0xcd4fa65fU),
                   bswap_32big(0xb225c8dfU));
    r_rsip_func045();
    WR1_PROG(REG_1444H, 0x000000a7U);
    WR1_PROG(REG_1608H, 0x800103a0U);
    WR1_PROG(REG_1458H, 0x00000000U);
    ...
    WR1_PROG(REG_1420H, bswap_32big(0x00000440U));
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func101(bswap_32big(0x593b49f7U),
                   bswap_32big(0xe112051eU),
                   bswap_32big(0x38a521deU),
                   bswap_32big(0xc934307eU));
    r_rsip_func046();
    r_rsip_func100(bswap_32big(0xd56269faU),
                   bswap_32big(0x9bc69dc0U),
                   bswap_32big(0x3fcc5d9dU),
                   bswap_32big(0x63010a46U));

...
void r_rsip_func422 (const uint32_t ARG1[], uint32_t ARG2)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xa14009faU),
                   bswap_32big(0xe2713903U),
                   bswap_32big(0x644b112fU),
                   bswap_32big(0x4c2be812U));
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xa4075c1aU), bswap_32big(0x19ed2f54U), bswap_32big(0xaa60977fU),
                       bswap_32big(0x72276cc1U));
    }

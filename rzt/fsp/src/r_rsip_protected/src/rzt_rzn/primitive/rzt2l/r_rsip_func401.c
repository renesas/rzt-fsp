...
void r_rsip_func401 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x140149dfU),
                   bswap_32big(0xe33689eeU),
                   bswap_32big(0x569520d2U),
                   bswap_32big(0x8c7d86e5U));
    ...
    r_rsip_func100(bswap_32big(0x9133cfacU),
                   bswap_32big(0x7c20e851U),
                   bswap_32big(0x42ea9275U),
                   bswap_32big(0x4d04fa1fU));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x01691a23U));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);

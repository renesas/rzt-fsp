...
void r_rsip_pb3u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x73687188U),
                   bswap_32big(0x266a0703U),
                   bswap_32big(0x131c5a57U),
                   bswap_32big(0xd2982845U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0x9cef4d8dU),
                   bswap_32big(0x80d865ebU),
                   bswap_32big(0xaf694c92U),
                   bswap_32big(0x2ce6f5bfU));
}

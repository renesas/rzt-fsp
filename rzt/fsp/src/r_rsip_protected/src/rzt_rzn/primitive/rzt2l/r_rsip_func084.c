...
void r_rsip_func084 ()
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xb4a4261dU),
                   bswap_32big(0xf5b4acb5U),
                   bswap_32big(0x584a2d44U),
                   bswap_32big(0x405d1092U));
    ...
    WR1_PROG(REG_1600H, 0x0000b7c0U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x01c9ada5U);
    WR1_PROG(REG_1458H, 0x00000000U);
    ...
    WR1_PROG(REG_1600H, 0x00000080U);
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0x7b013b7eU),
                   bswap_32big(0x801a9bd6U),
                   bswap_32big(0x2f609d83U),
                   bswap_32big(0x0f24dfd7U));

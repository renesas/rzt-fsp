    ...
    else
    {
        ...
        else
        {
            ...
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func100(bswap_32big(0x85a9acbcU),
                               bswap_32big(0xc629d00aU),
                               bswap_32big(0x29a1a983U),
                               bswap_32big(0xea994a05U));
                WR1_PROG(REG_1608H, 0x810103c0U);
                WR1_PROG(REG_1458H, 0x00000000U);
                WR1_PROG(REG_1408H, 0x00005006U);
                WAIT_STS(REG_1408H, 30U, 1U);
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0xf57fac12U),
                                   bswap_32big(0x195f0e65U),
                                   bswap_32big(0x5a9c381dU),
                                   bswap_32big(0x0b4f8609U));
                }
                ...
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func100(bswap_32big(0x81aceb3eU),
                               bswap_32big(0x1652759eU),
                               bswap_32big(0xf3b88a8dU),
                               bswap_32big(0x5d481961U));
                WR1_PROG(REG_1600H, 0x0000b4e0U);
                WR1_PROG(REG_1458H, 0x00000000U);
                WR1_PROG(REG_1600H, 0x00000010U);
                WR1_PROG(REG_1458H, 0x00000000U);
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0x1393535fU),
                                   bswap_32big(0xc8a66591U),
                                   bswap_32big(0x71bb3797U),
                                   bswap_32big(0xaba79280U));
                }

                r_rsip_func100(bswap_32big(0x8d1c99d7U),
                               bswap_32big(0x46a3bcf4U),
                               bswap_32big(0x258ec731U),
                               bswap_32big(0x8091ae93U));
                ...
                r_rsip_func101(bswap_32big(0x21a5ce82U),
                               bswap_32big(0x856dce47U),
                               bswap_32big(0xd0d00e3eU),
                               bswap_32big(0x9e7ee208U));
            }

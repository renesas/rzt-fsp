...
void r_rsip_func406 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x21066355U),
                   bswap_32big(0xa3161ee8U),
                   bswap_32big(0xa3836eecU),
                   bswap_32big(0xd4245962U));
    ...
    r_rsip_func100(bswap_32big(0xe294db83U),
                   bswap_32big(0x5786f472U),
                   bswap_32big(0x49ca7bffU),
                   bswap_32big(0xa53137edU));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x0189b8b2U));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);

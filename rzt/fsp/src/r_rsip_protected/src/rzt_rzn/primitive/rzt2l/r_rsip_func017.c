...
void r_rsip_func017 (uint32_t ARG1)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xf0f044cdU),
                   bswap_32big(0x9848080dU),
                   bswap_32big(0xc2d45ee4U),
                   bswap_32big(0xa0770f96U));
    ...
    for (oLoop = 0; oLoop < S_RAM[0 + 2]; oLoop = oLoop + 4)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xfd809c96U), bswap_32big(0x02796e78U), bswap_32big(0x3347bceeU),
                       bswap_32big(0x1c30f5a2U));
    }

...
rsip_ret_t r_rsip_pb6f (const uint32_t InData_TextBitLen[], const uint32_t InData_Text[], uint32_t OutData_Text[])
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                r_rsip_func100(bswap_32big(0x6fe8573cU),
                               bswap_32big(0xfda6d6a5U),
                               bswap_32big(0x099522f8U),
                               bswap_32big(0xc73d2b3fU));
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0x3a2f88b6U),
                                   bswap_32big(0xd840de39U),
                                   bswap_32big(0x71231f0aU),
                                   bswap_32big(0x94ae1239U));
                }

                r_rsip_func100(bswap_32big(0x66e0998cU),
                               bswap_32big(0xff4b9c9bU),
                               bswap_32big(0x7029a79aU),
                               bswap_32big(0xde982b1fU));
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0xd5825cc3U),
                                   bswap_32big(0xcf3fc9baU),
                                   bswap_32big(0x00e7bcd4U),
                                   bswap_32big(0x11e28e79U));
                }

                r_rsip_func100(bswap_32big(0x14419ce4U),
                               bswap_32big(0x41fb3d20U),
                               bswap_32big(0xe5f0631cU),
                               bswap_32big(0x6911c743U));
                ...
                r_rsip_func101(bswap_32big(0x9ec90ac9U),
                               bswap_32big(0xc311c895U),
                               bswap_32big(0x3bbe47aeU),
                               bswap_32big(0x899d37bcU));
            }

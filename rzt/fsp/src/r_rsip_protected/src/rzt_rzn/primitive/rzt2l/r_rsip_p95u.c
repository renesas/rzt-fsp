...
void r_rsip_p95u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xf763dce0U),
                   bswap_32big(0xf8770e09U),
                   bswap_32big(0x22c8a57eU),
                   bswap_32big(0x86e97d3fU));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0x7de96bb7U),
                   bswap_32big(0x0d22ba2bU),
                   bswap_32big(0x3d621b17U),
                   bswap_32big(0x6161bec2U));
}

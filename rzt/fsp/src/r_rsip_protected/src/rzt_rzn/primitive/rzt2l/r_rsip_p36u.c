...
void r_rsip_p36u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xe590aadfU),
                   bswap_32big(0x85ccaa24U),
                   bswap_32big(0xb4f82292U),
                   bswap_32big(0xd2dd1b18U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0x3f3cbf18U),
                   bswap_32big(0x7d1d1a17U),
                   bswap_32big(0x38562abeU),
                   bswap_32big(0xd766c346U));
}

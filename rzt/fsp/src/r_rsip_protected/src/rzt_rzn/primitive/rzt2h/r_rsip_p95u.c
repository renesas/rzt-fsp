...
void r_rsip_p95u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x6f6b1e95U),
                   bswap_32big(0x6e98ec62U),
                   bswap_32big(0xb7f7504cU),
                   bswap_32big(0xdd1fa1a4U));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0xa789aa36U),
                   bswap_32big(0xa4feaf15U),
                   bswap_32big(0x5fd3466aU),
                   bswap_32big(0x169d2e29U));
}

    ...
    else
    {
        ...
        else
        {
            ...
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func100(bswap_32big(0x2a4b8d7fU),
                               bswap_32big(0x9e42d401U),
                               bswap_32big(0x6b4b5621U),
                               bswap_32big(0xd1f0d6aaU));
                WR1_PROG(REG_1608H, 0x810103c0U);
                WR1_PROG(REG_1458H, 0x00000000U);
                WR1_PROG(REG_1408H, 0x00005006U);
                WAIT_STS(REG_1408H, 30U, 1U);
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0xb5fa19d9U),
                                   bswap_32big(0x66e984deU),
                                   bswap_32big(0xc11880f2U),
                                   bswap_32big(0xb4b7b7c9U));
                }
                ...
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func100(bswap_32big(0xa2f34c80U),
                               bswap_32big(0x40736c58U),
                               bswap_32big(0x67db21c8U),
                               bswap_32big(0x6cfcaabaU));
                WR1_PROG(REG_1600H, 0x0000b4e0U);
                WR1_PROG(REG_1458H, 0x00000000U);
                WR1_PROG(REG_1600H, 0x00000010U);
                WR1_PROG(REG_1458H, 0x00000000U);
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    WR1_PROG(REG_1458H, 0x00000000U);
                    r_rsip_func101(bswap_32big(0x8b1a33aeU),
                                   bswap_32big(0x1833f5b5U),
                                   bswap_32big(0x2e2e071aU),
                                   bswap_32big(0xfcb8dc9aU));
                }

                r_rsip_func100(bswap_32big(0x2c3e5c99U),
                               bswap_32big(0xf251122aU),
                               bswap_32big(0x03ff237bU),
                               bswap_32big(0x279d50f9U));
                ...
                r_rsip_func101(bswap_32big(0x067c4a8aU),
                               bswap_32big(0x34f570a9U),
                               bswap_32big(0x84d31c5cU),
                               bswap_32big(0xfd607c28U));
            }

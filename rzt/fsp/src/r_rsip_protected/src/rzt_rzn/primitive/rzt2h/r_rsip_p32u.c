...
void r_rsip_p32u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x9e1f69eeU),
                   bswap_32big(0x29fb016cU),
                   bswap_32big(0x66c25cceU),
                   bswap_32big(0x10ea02fdU));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0x72992009U),
                   bswap_32big(0x505b088dU),
                   bswap_32big(0x4982a1e1U),
                   bswap_32big(0x8cd99657U));
}

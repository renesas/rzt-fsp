...
void r_rsip_func401 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x23b48574U),
                   bswap_32big(0xa0baae8aU),
                   bswap_32big(0x02f5e377U),
                   bswap_32big(0xfe2f61c5U));
    ...
    r_rsip_func100(bswap_32big(0x8fe9b894U),
                   bswap_32big(0xf5918c95U),
                   bswap_32big(0x844383c3U),
                   bswap_32big(0xae7d64caU));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x014ca732U));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);

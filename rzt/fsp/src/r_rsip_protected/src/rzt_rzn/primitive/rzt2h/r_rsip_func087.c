...
void r_rsip_func087 (uint32_t ARG1)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xe8e49424U),
                   bswap_32big(0xbeee5480U),
                   bswap_32big(0xea00eb04U),
                   bswap_32big(0xe4ae33caU));
    ...
    WR1_PROG(REG_1600H, 0x00000080U);
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0xb3edf130U),
                   bswap_32big(0x403da627U),
                   bswap_32big(0x64615ca4U),
                   bswap_32big(0x22b1bcc9U));

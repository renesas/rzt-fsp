...
void r_rsip_pc2u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xf77032d0U),
                   bswap_32big(0xb4b784e4U),
                   bswap_32big(0x2c6bebf6U),
                   bswap_32big(0x1e3737f9U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0xaeaf364eU),
                   bswap_32big(0xa471b78fU),
                   bswap_32big(0x87a6861fU),
                   bswap_32big(0x4c41a17fU));
}

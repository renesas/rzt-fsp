...
rsip_ret_t r_rsip_p40 (const uint32_t InData_KeyIndex[])
{
    ...
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func101(bswap_32big(0x16c0558fU),
                   bswap_32big(0x7341a7d5U),
                   bswap_32big(0x923edd62U),
                   bswap_32big(0x573d3fbaU));
    r_rsip_func040();
    ...
    WAIT_STS(REG_1404H, 30U, 0U);
    WR1_PROG(REG_143CH, 0x00001800U);
    r_rsip_func100(bswap_32big(0x14a83deaU),
                   bswap_32big(0x6688d99fU),
                   bswap_32big(0xdfac81bfU),
                   bswap_32big(0x8bb476edU));
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);
    if (CHCK_STS(REG_143CH, 22U, 1U))
    {
        r_rsip_func102(bswap_32big(0xefac4ea4U), bswap_32big(0xfab3effeU), bswap_32big(0xfdd4e7bcU),
                       bswap_32big(0x9bac1fdeU));
    ...
    else
    {
        ...
        r_rsip_func102(bswap_32big(0x5198c965U), bswap_32big(0xbdf246c7U), bswap_32big(0x7d2f4d55U),
                       bswap_32big(0x3e001dc7U));
        WR1_PROG(REG_14BCH, 0x00000040U);
        WAIT_STS(REG_142CH, 12U, 0U);

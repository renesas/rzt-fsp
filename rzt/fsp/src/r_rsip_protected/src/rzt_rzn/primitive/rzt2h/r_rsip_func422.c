...
void r_rsip_func422 (const uint32_t ARG1[], uint32_t ARG2)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xc4040825U),
                   bswap_32big(0x8aa74c35U),
                   bswap_32big(0x3e40032eU),
                   bswap_32big(0x3cf554b6U));
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0x6486695fU), bswap_32big(0x0c46e467U), bswap_32big(0xa78161f0U),
                       bswap_32big(0x70cc046eU));
    }

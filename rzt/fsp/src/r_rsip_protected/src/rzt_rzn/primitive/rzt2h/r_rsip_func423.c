...
void r_rsip_func423 (uint32_t ARG1[], uint32_t ARG2)
{
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xc3ab28c7U), bswap_32big(0xc10d5384U), bswap_32big(0xd5a1801eU),
                       bswap_32big(0x1d937564U));
    }

    r_rsip_func100(bswap_32big(0x2a243a96U),
                   bswap_32big(0x437639c1U),
                   bswap_32big(0x429af557U),
                   bswap_32big(0x7d0cc796U));

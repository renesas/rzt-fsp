...
void r_rsip_pb6u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x04238ce9U),
                   bswap_32big(0x78729087U),
                   bswap_32big(0x1d718f69U),
                   bswap_32big(0x868593daU));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0x8a1a51f7U),
                   bswap_32big(0x519be455U),
                   bswap_32big(0xc3d1f76bU),
                   bswap_32big(0x693a24c3U));
}

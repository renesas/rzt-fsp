...
void r_rsip_func440 (const uint32_t ARG1[])
{
    ...
    r_rsip_func101(bswap_32big(0xa78390d0U),
                   bswap_32big(0x77b56684U),
                   bswap_32big(0xc88f74d8U),
                   bswap_32big(0xf59354d8U));
    r_rsip_func045();
    r_rsip_subfunc009(bswap_32big(0x00000440U));
    r_rsip_func101(bswap_32big(0x712590d6U),
                   bswap_32big(0xee61c3eeU),
                   bswap_32big(0xc7171aa2U),
                   bswap_32big(0x938ddeb0U));
    r_rsip_func046();
    r_rsip_func100(bswap_32big(0x0d61606aU),
                   bswap_32big(0x4aea65ddU),
                   bswap_32big(0xb8423ba1U),
                   bswap_32big(0xcd8e6e86U));

                        ...
                        uint32_t       KEY_INDEX_SIZE)
{
    ...
    else
    {
        ...
        if (0x00000000U == RD1_MASK(REG_1440H, 0xffffffffU))
        {
            ...
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x350ef30cU), bswap_32big(0xc98c91edU), bswap_32big(0x4623ac30U),
                           bswap_32big(0x10df381eU));
        }
        else if (0x00000001U == RD1_MASK(REG_1440H, 0xffffffffU))
        {
            ...
            WR1_PROG(REG_1600H, 0x00000008U);
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x464b0127U), bswap_32big(0xe1280714U), bswap_32big(0x4f719259U),
                           bswap_32big(0x9ea670c8U));
        }
        else if (0x00000002U == RD1_MASK(REG_1440H, 0xffffffffU))
        {
            ...
            WR1_PROG(REG_1600H, 0x00000008U);
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x9c2553f3U), bswap_32big(0x62fca30eU), bswap_32big(0x68d96a5fU),
                           bswap_32big(0xf68e12a8U));
        }
        else if (0x00000005U == RD1_MASK(REG_1440H, 0xffffffffU))
        {
            ...
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x27514ae9U), bswap_32big(0x7dfdd570U), bswap_32big(0x2fb4e951U),
                           bswap_32big(0x3fdd653aU));
        }
        else if (0x00000006U == RD1_MASK(REG_1440H, 0xffffffffU))
        {
            ...
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x3338ddf1U), bswap_32big(0xd3b0f5cdU), bswap_32big(0x567ff3cbU),
                           bswap_32big(0xa83b3dadU));
        }
        ...
        r_rsip_func101(bswap_32big(0xb9d10adbU), bswap_32big(0x14efbc6dU), bswap_32big(0xa7a11242U),
                       bswap_32big(0xa1bc8d36U));
        r_rsip_func045();
        WR1_PROG(REG_1600H, 0x000034e5U);
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_subfunc009(bswap_32big(0x00007502U));
        r_rsip_func101(bswap_32big(0xdd9a2516U), bswap_32big(0xb5b0d307U), bswap_32big(0xccfebc18U),
                       bswap_32big(0x682ab0e0U));
        r_rsip_func046();
        ...
        for (iLoop = 0; iLoop < KEY_INDEX_SIZE - 8; iLoop = iLoop + 4)
        {
            ...
            WR1_PROG(REG_1600H, 0x00000004U);
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0x75aff81dU), bswap_32big(0x03f1e470U), bswap_32big(0x77af1350U),
                           bswap_32big(0x79a8a6caU));
        }
        ...
        r_rsip_func100(bswap_32big(0x83c6a176U), bswap_32big(0xe0bf2cf7U), bswap_32big(0xde967bd7U),
                       bswap_32big(0xa55e9832U));
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);
        if (CHCK_STS(REG_143CH, 22U, 1U))
        {
            r_rsip_func102(bswap_32big(0x1e3071a0U), bswap_32big(0x7b7e13f8U), bswap_32big(0xd2efb2c0U),
                           bswap_32big(0x604bf37dU));
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12U, 0U);
        ...
        else
        {
            ...
            r_rsip_func101(bswap_32big(0xda8f82bfU), bswap_32big(0xfb74305dU), bswap_32big(0xabe1ad26U),
                           bswap_32big(0x1620b7edU));

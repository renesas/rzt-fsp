...
void r_rsip_func016 (uint32_t ARG1)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x8861d101U),
                   bswap_32big(0xa2fce764U),
                   bswap_32big(0xd50162b3U),
                   bswap_32big(0x72158c91U));
    ...
    for (oLoop = 0; oLoop < S_RAM[0 + 2]; oLoop = oLoop + 4)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func100(bswap_32big(0x6c40dd50U), bswap_32big(0x8e221602U), bswap_32big(0x4b5f69a1U),
                       bswap_32big(0x14816eb3U));
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xa87eaf1aU), bswap_32big(0xa944d3f3U), bswap_32big(0xdd270690U),
                       bswap_32big(0xe310c6ccU));
    }
    ...
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0x7c21b44dU),
                   bswap_32big(0x9f71349cU),
                   bswap_32big(0xf1ceb253U),
                   bswap_32big(0x277abbf6U));
    WR1_PROG(REG_1444H, 0x000000a2U);

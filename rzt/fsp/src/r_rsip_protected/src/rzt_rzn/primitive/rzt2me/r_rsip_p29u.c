...
void r_rsip_p29u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x7045f439U),
                   bswap_32big(0x8f47780bU),
                   bswap_32big(0xb205103bU),
                   bswap_32big(0xd18c4597U));
    ...
    r_rsip_func100(bswap_32big(0x9c312abaU),
                   bswap_32big(0x74c8fa0eU),
                   bswap_32big(0x7a45e08eU),
                   bswap_32big(0xe82f87b2U));
    ...
    r_rsip_func101(bswap_32big(0x8e99e7a6U),
                   bswap_32big(0x3f4cd9a7U),
                   bswap_32big(0x1379fd4cU),
                   bswap_32big(0x309dcf60U));
}

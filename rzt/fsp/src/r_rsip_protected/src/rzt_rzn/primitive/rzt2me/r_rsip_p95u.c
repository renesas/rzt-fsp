...
void r_rsip_p95u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xee2bf5c3U),
                   bswap_32big(0x12eb271bU),
                   bswap_32big(0xd538fedaU),
                   bswap_32big(0x1bed31ccU));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0x5e9d7a65U),
                   bswap_32big(0x7fa50e42U),
                   bswap_32big(0xc53c6e00U),
                   bswap_32big(0xd5187d18U));
}

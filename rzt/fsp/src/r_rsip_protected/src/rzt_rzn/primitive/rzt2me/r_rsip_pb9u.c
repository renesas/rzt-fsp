...
void r_rsip_pb9u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x18b7c4d0U),
                   bswap_32big(0x85efa59fU),
                   bswap_32big(0x05a02c6cU),
                   bswap_32big(0x505c8d05U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0x625fb061U),
                   bswap_32big(0xee787bafU),
                   bswap_32big(0x9fea9816U),
                   bswap_32big(0xc5da9056U));
}

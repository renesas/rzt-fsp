...
void r_rsip_func406 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x68c50222U),
                   bswap_32big(0x048daaf2U),
                   bswap_32big(0xddb72b29U),
                   bswap_32big(0xe893e7e1U));
    ...
    r_rsip_func100(bswap_32big(0xeebc50f8U),
                   bswap_32big(0x0a196e12U),
                   bswap_32big(0x0eb6a15bU),
                   bswap_32big(0xe552d475U));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x01d2b549U));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);

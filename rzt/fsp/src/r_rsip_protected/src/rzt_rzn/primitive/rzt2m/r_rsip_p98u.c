...
void r_rsip_p98u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x9dafa370U),
                   bswap_32big(0x7bef738bU),
                   bswap_32big(0xc4be3545U),
                   bswap_32big(0xf237f972U));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0xb30e11faU),
                   bswap_32big(0x691f09a2U),
                   bswap_32big(0xb630eb63U),
                   bswap_32big(0xf5ba5a08U));
}

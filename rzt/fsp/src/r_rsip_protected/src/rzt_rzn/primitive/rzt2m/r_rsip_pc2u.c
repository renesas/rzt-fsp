...
void r_rsip_pc2u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xe414be4cU),
                   bswap_32big(0xcc6ea16eU),
                   bswap_32big(0x4334ad62U),
                   bswap_32big(0x6cc141c9U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0xe21e170fU),
                   bswap_32big(0x8e0832e5U),
                   bswap_32big(0xc8ece48fU),
                   bswap_32big(0xbbaa3ba1U));
}

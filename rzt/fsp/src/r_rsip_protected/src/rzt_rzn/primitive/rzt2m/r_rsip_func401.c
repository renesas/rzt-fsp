...
void r_rsip_func401 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x09452173U),
                   bswap_32big(0xb677edcbU),
                   bswap_32big(0x90fcfb56U),
                   bswap_32big(0xc4b88ac8U));
    ...
    r_rsip_func100(bswap_32big(0x9239c090U),
                   bswap_32big(0x8793d549U),
                   bswap_32big(0xa4279fa0U),
                   bswap_32big(0xb7b7bb05U));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x0179670aU));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);

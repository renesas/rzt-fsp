...
void r_rsip_func423 (uint32_t ARG1[], uint32_t ARG2)
{
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xe7e79832U), bswap_32big(0xcafb700fU), bswap_32big(0x66ed7eb1U),
                       bswap_32big(0x5201c02cU));
    }

    r_rsip_func100(bswap_32big(0xf1b15399U),
                   bswap_32big(0xee94cbcdU),
                   bswap_32big(0xf70706afU),
                   bswap_32big(0xbb40201aU));

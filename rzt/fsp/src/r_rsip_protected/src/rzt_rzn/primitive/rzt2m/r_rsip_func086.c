...
void r_rsip_func086 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xb165f9e5U),
                   bswap_32big(0x4e0f27caU),
                   bswap_32big(0x841f5131U),
                   bswap_32big(0x0d52b464U));
    ...
    WR1_PROG(REG_1600H, 0x00000080U);
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0x50de3e0eU),
                   bswap_32big(0xea1c343bU),
                   bswap_32big(0x68164173U),
                   bswap_32big(0x82f174c7U));

...
void r_rsip_p34u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xb0080a8dU),
                   bswap_32big(0x369caf98U),
                   bswap_32big(0xa37c0e1fU),
                   bswap_32big(0x1f0730fdU));
    ...
    r_rsip_func100(bswap_32big(0x8416045eU),
                   bswap_32big(0xec80f0aaU),
                   bswap_32big(0xf830ef6eU),
                   bswap_32big(0x58f16ab2U));
    ...
    r_rsip_func101(bswap_32big(0x677a4559U),
                   bswap_32big(0xa7d0d168U),
                   bswap_32big(0x72c81ff0U),
                   bswap_32big(0xf04490aeU));
}

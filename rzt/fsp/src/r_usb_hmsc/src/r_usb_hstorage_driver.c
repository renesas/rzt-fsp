 ...
 ******************************************************************************/
uint16_t g_usb_hmsc_strg_process[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;

/* static uint8_t g_usb_hmsc_data[USB_NUM_USBIP][64];*/     /* Full-Speed MAXPS */
static uint8_t g_usb_hmsc_data[USB_NUM_USBIP][USB_VALUE_512] USB_BUFFER_PLACE_IN_SECTION; /* Hi-Speed MAXPS */
 #if (BSP_CFG_RTOS == 0)
...
uint8_t g_usb_hmsc_rs_data[USB_VALUE_512] USB_BUFFER_PLACE_IN_SECTION; /* Request Sense Data Buffer */

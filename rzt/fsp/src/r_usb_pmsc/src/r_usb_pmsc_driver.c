...
static usb_msc_cbw_t g_usb_pmsc_cbw USB_BUFFER_PLACE_IN_SECTION;

/* Mass Storage Device Class CSW */
static usb_msc_csw_t g_usb_pmsc_csw USB_BUFFER_PLACE_IN_SECTION;

/* PMSC UTR */
usb_utr_t g_usb_pmsc_utr USB_BUFFER_PLACE_IN_SECTION;
...
static uint8_t g_usb_pmsctrans_complete USB_BUFFER_PLACE_IN_SECTION;
#endif                                 /* (BSP_CFG_RTOS == 0) */

/* Transfer Status */
static uint16_t g_usb_pmscstatus USB_BUFFER_PLACE_IN_SECTION;
...
uint32_t g_usb_pmsc_dtl USB_BUFFER_PLACE_IN_SECTION;

/* Mass Storage Device Class */
usb_pmsc_cbm_t g_usb_pmsc_message USB_BUFFER_PLACE_IN_SECTION;

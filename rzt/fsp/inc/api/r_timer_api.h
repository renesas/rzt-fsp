...
typedef struct st_timer_api
{
     ...
     *
     * @par Implemented as
     * - @ref R_CMT_DutyCycleSet()
     * - @ref R_CMTW_DutyCycleSet()
     ...
     * @par Implemented as
     * - @ref R_CMT_CallbackSet()
     * - @ref R_CMTW_CallbackSet()
     ...
     * @par Implemented as
     * - @ref R_CMT_VersionGet()
     * - @ref R_CMTW_VersionGet()

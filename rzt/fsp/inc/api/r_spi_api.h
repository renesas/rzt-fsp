...
#define SPI_API_VERSION_MINOR    (3U)  // DEPRECATED
...
typedef struct st_spi_cfg
{
    ...
    transfer_instance_t const * p_transfer_tx;         ///< To use SPI DMAC write transfer, link a DMAC instance here.  Set to NULL if unused.
    transfer_instance_t const * p_transfer_rx;         ///< To use SPI DMAC read transfer, link a DMAC instance here.  Set to NULL if unused.

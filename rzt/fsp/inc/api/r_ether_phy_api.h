...
#define ETHER_PHY_API_VERSION_MINOR    (3U) // DEPRECATED
...
{
    ETHER_PHY_MII_TYPE_MII   = 0,      ///< MII type
    ETHER_PHY_MII_TYPE_RMII  = 1,      ///< RMII type
    ETHER_PHY_MII_TYPE_GMII  = 2,      ///< GMII type
    ETHER_PHY_MII_TYPE_RGMII = 3       ///< RGMII type

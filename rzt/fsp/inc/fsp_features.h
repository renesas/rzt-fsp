...
typedef enum e_fsp_signal
{
    ...
    FSP_SIGNAL_DMAC0_INT8     = (29),  ///< DMAC0 transfer completion 8
    FSP_SIGNAL_DMAC0_INT9     = (30),  ///< DMAC0 transfer completion 9
    FSP_SIGNAL_DMAC0_INT10    = (31),  ///< DMAC0 transfer completion 10
    FSP_SIGNAL_DMAC0_INT11    = (32),  ///< DMAC0 transfer completion 11
    FSP_SIGNAL_DMAC0_INT12    = (33),  ///< DMAC0 transfer completion 12
    FSP_SIGNAL_DMAC0_INT13    = (34),  ///< DMAC0 transfer completion 13
    FSP_SIGNAL_DMAC0_INT14    = (35),  ///< DMAC0 transfer completion 14
    FSP_SIGNAL_DMAC0_INT15    = (36),  ///< DMAC0 transfer completion 15
    ...
    FSP_SIGNAL_DMAC1_INT8     = (45),  ///< DMAC1 transfer completion 8
    FSP_SIGNAL_DMAC1_INT9     = (46),  ///< DMAC1 transfer completion 9
    FSP_SIGNAL_DMAC1_INT10    = (47),  ///< DMAC1 transfer completion 10
    FSP_SIGNAL_DMAC1_INT11    = (48),  ///< DMAC1 transfer completion 11
    FSP_SIGNAL_DMAC1_INT12    = (49),  ///< DMAC1 transfer completion 12
    FSP_SIGNAL_DMAC1_INT13    = (50),  ///< DMAC1 transfer completion 13
    FSP_SIGNAL_DMAC1_INT14    = (51),  ///< DMAC1 transfer completion 14
    FSP_SIGNAL_DMAC1_INT15    = (52),  ///< DMAC1 transfer completion 15
    ...
    FSP_SIGNAL_ENCIF_INT0     = (372), ///< ENCIF CH0 Interrupt A
    FSP_SIGNAL_ENCIF_INT1     = (373), ///< ENCIF CH0 Interrupt B
    FSP_SIGNAL_ENCIF_INT2     = (374), ///< ENCIF CH0 OUTPUT FIFO Interrupt
    FSP_SIGNAL_ENCIF_INT3     = (375), ///< ENCIF CH0 INPUT FIFO Interrupt
    FSP_SIGNAL_ENCIF_INT4     = (376), ///< ENCIF CH1 Interrupt A
    FSP_SIGNAL_ENCIF_INT5     = (377), ///< ENCIF CH1 Interrupt B
    FSP_SIGNAL_ENCIF_INT6     = (378), ///< ENCIF CH1 OUTPUT FIFO Interrupt
    ...
    FSP_SIGNAL_CPU1_ERR0      = (386), ///< Cortex-R52 CPU1 error event 0
    FSP_SIGNAL_CPU1_ERR1      = (387), ///< Cortex-R52 CPU1 error event 1

...
/** SCI clock source */
typedef enum e_sci_i2c_clock_source
{
    SCI_I2C_CLOCK_SOURCE_SCINASYNCCLK = 0,
    SCI_I2C_CLOCK_SOURCE_PCLKM,
} sci_i2c_clock_source_t;

/** I2C clock settings */
typedef struct st_sci_i2c_clock_settings
{
    ...
    sci_i2c_clock_source_t clock_source;       ///< Clock source (PCLKM or SCInASYNCCLK)

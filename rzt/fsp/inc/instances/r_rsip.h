...
/* Value size */
#define RSIP_BYTE_SIZE_ENCRYPTED_AUTH_PASSWORD          RSIP_BYTE_SIZE_ENCRYPTED_KEY(4)
#define RSIP_BYTE_SIZE_HASHED_AUTH_PASSWORD             (32U)
#define RSIP_PRV_BYTE_SIZE_ROOT_CERT_MAC                RSIP_BYTE_SIZE_WRAPPED_KEY(4)
...
typedef struct st_rsip_sb_common_key
{
    uint8_t value[RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_AES_128)];
} rsip_sb_common_key_t;

/** Hashed authentication password */
typedef struct st_rsip_hashed_auth_password
{
    uint8_t value[RSIP_BYTE_SIZE_HASHED_AUTH_PASSWORD];
} rsip_hashed_auth_password_t;

/** MAC of root certificate injection */
typedef struct st_rsip_root_cert_mac
{
    uint8_t value[RSIP_PRV_BYTE_SIZE_ROOT_CERT_MAC];
